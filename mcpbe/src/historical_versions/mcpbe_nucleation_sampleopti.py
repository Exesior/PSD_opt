...
# pbe-core or wmcpbe. Nucleation with a cached sampler instead of a full rebuild per droplet. An intermediate step towards the dual/timestep-sampler variants below.

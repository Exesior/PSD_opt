...
# pbe-core or wmcpbe. The original, unweighted solver this project started from -- self-contained, no pbe-core dependency. Superseded first by mcpbe_new_stru.py, later by the weighted wmcpbe package.

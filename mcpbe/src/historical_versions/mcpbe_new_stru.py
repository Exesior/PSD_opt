...
# pbe-core or wmcpbe. Attempt to rebuild the original solver (mcpbe_old_stru.py) on top of the shared pbe-core base and JIT kernels, instead of the original's self-contained implementation.

"""
Exponential Decay Compression Kernel.
...
class ExponentialDecayKernel(CompressionKernel):
    """
    ...
    Example:
        >>> kernel = ExponentialDecayKernel(rate=0.02, min_porosity=0.3)
        >>> poro_new = kernel.compute_porosity_decay(poro=0.5, dt=1.0)
